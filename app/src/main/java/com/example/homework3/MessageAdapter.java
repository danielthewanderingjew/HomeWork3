...
public class MessageAdapter extends RecyclerView.Adapter<MessageViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MessageViewHolder holder, int position) {
        ...
        if (message.userID.equals(userID)) {
            ...
            holder.messageCard_new.setVisibility(View.VISIBLE);
            holder.message_new.setText(message.message);
            holder.userName_new.setText(message.userName);
            Glide.with(holder.userImage_new.getContext()).load(message.userPhoto).into(holder.userImage_new);
        } else {
            holder.messageCard_new.setVisibility(View.GONE);
