...
public class ChatActivity extends AppCompatActivity {
    ...
    private void sendCloudMessage(chatMessage m) {
        String serverKey = "AAAAsZeobg4:APA91bE67pTON-KWPOnsNtvLixEemPRfqQaIPx4WgKkZD8f1OKSLshze7qt09RQslwmGBlPQKec3wiiV1wycOgsOMhX6g6zYhcZoryj03KnLYkdSyh4JELZYiXPA4VqID3Ot6nnLvZeX";
        String topic = "chat";
